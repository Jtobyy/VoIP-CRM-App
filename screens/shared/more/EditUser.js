...
import SuccessModal from '../../../components/Modals/user/EditUserModal';
...
const handleEditUser = async () => {
  ...
  try {
    ...
    await api.patch(`/users/${userId}/`, formDataToSend, {
      ...
      <View style={styles.overlayIcon}>
        ...
        <View style={styles.form}>
         ...
         <View style={styles.input}>
          ...
          <TouchableOpacity style={styles.primaryBtn} onPress={handleEditUser}>
            <Text style={styles.primaryText}>Edit User</Text>
          </TouchableOpacity>
